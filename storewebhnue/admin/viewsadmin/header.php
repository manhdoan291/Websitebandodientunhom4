    ...
    <div class="container_12">
        <div class="grid_12 header-repeat">
            <div id="branding">
                <div class="floatleft logo">
                    <img src="../img/logodhsphn.png" alt="Logo" />
				</div>
				<div class="floatleft middle">
					<h1>Website cửa hàng bán phụ kiện bằng lập trình php oop</h1>
					<p>manhdoanhoang.000webhostapp.com</p>
				</div>
        ...
        <div class="grid_12">
            <ul class="nav main">
                ...
                <li class="ic-charts"><a href="index.php"><span>Giao diện khách hàng</span></a></li>
            </ul>
        </div>
        <div class="clear">
        </div>
